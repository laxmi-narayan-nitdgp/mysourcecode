<%-- 
    Document   : 10
    Created on : Sep 21, 2012, 1:42:34 AM
...
<div id="footer">
        ...
        <form name="f6" action="middle.jsp" method="post">
           ...
           <br><br>
           <h1 class="winn">Question 10.</h1>
           <br><br> 
            <div class="mod">
                <label><p class="customfont">enter your favrite game(nfs)</p></label>
                <input type="text" name="ans" required id="xbt"/>
                <input type="hidden" value="10" name="hdd" />
