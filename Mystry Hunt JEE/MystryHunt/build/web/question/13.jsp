<%-- 
    Document   : 13
    Created on : Sep 21, 2012, 1:42:58 AM
...
<div id="footer">
        ...
        <form name="f6" action="middle.jsp" method="post">
            <br><br>   
           <h1 class="winn">Question 13.</h1>
           <br><br>
            <div class="mod">
                <label><p class="customfont">Glasswas there and fish inside(glassfish)</p></label>
                <input type="text" name="ans" required id="xbt"/>
                <input type="hidden" value="13" name="hdd" />
