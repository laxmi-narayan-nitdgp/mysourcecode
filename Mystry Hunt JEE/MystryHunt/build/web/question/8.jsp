<%-- 
    Document   : 8
    Created on : Sep 21, 2012, 1:42:19 AM
...
<div id="footer">
        ...
        <form name="f6" action="middle.jsp" method="post">
            <br><br>   
           <h1 class="winn">Question 8.</h1>
           <br><br>
            <div class="mod">
                <label><p class="customfont">He is the daughter of the broswer who's mother was fox(4)</p></label>
                <input type="text" name="ans" required id="xbt"/>
                <input type="hidden" value="8" name="hdd" />
