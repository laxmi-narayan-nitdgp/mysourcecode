<%-- 
    Document   : 14
    Created on : Sep 21, 2012, 1:43:06 AM
...
<div id="footer">
        ...
        <form name="f6" action="middle.jsp" method="post">
            <br><br>
           <h1 class="winn">Question 14.</h1>
           <br><br>
            <div class="mod">
                <label><p class="customfont">fffffffffffffffhfffffffifffffddfffffffefffnfpffffffffffffrfffffffiffffffvfffffffffaffffffcffffffffffyffff(dell)</p></label>
                <input type="text" name="ans" required id="xbt"/>
                <input type="hidden" value="14" name="hdd" />
