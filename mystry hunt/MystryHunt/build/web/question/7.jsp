<%-- 
    Document   : 7
    Created on : Sep 21, 2012, 1:42:06 AM
...
<div id="footer">
        ...
        <form name="f6" action="middle.jsp" method="post">
            <br><br>
           <h1 class="winn">Question 7.</h1>
           <br><br>
            <div class="mod">
                <label><p class="customfont">enter your favrite Nick Name(dwww)</p></label>
                <input type="text" name="ans" required id="xbt"/>
                <input type="hidden" value="7" name="hdd" />
