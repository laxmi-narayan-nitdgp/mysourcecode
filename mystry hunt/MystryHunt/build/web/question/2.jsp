...
<div id="footer">
        ...
        <form name="f2" action="middle.jsp" method="post">
                         <div>
                <br><br>
                <h1 class="winn">Question 2.</h1>
                <br><br>
            <div class="mod">

                <label><p class="customfont">enter your favrite title(programmer)</p></label>
                <input type="text" name="ans" required id="xbt"/>
                <input type="hidden" value="2" name="hdd"/>
